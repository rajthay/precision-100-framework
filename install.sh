...
cat >> $PRECISION100_FOLDER/conf/.spoolenv << 'SPOOLENV'
export SPOOL_PATH=$PRECISION100_WORK_FOLDER/spool
export DEFAULT_QUOTE="OFF"
export DEFAULT_DELIMITER=","
SPOOLENV

cat >> $PRECISION100_FOLDER/conf/.sqlloaderenv << 'SQLLOADERENV'
...
cat > $PRECISION100_FOLDER/conf/.smart-sqlloaderenv << 'SMARTSQLLOADERENV'
...
cat > $PRECISION100_FOLDER/conf/.map-file.env << 'MAP-FILE'
export MAP_FILE_SQL_FOLDER=$PRECISION100_WORK_FOLDER/map-file/sql
MAP-FILE
