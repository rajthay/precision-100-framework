...
export REPO_LOCAL_FOLDER=$PRECISION100_WORK_FOLDER/git-local

export REPO_URL=http://localhost:50080/precision-100-migration-framework/precision-100-migration-templates.git
