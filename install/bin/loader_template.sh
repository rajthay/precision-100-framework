...
sqlldr control=$1 data=$2 log=$3 bad=$4 direct=true errors=1000000 bindsize=5048576 multithreading=true << LOADER 1> >(tee -a $PRECISION100_LOG_FOLDER/loader.log) 2> >(tee -a $PRECISION100_LOG_FOLDER/loader-err.log >&2)
