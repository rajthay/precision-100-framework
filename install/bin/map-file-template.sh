...
grep -i -v ${MAP_FILE_JOIN_FILTER} $SOURCE_FILE > "${MAP_FILE_WORK_FOLDER}/$FILE_NAME.$MAP_FILE_FILE_SUFFIX.ddl"
sed -n "s/${MAP_FILE_JOIN_FILTER},//p" $SOURCE_FILE  > "${MAP_FILE_WORK_FOLDER}/${FILE_NAME}.${MAP_FILE_FILE_SUFFIX}.join"
