...
$PRECISION100_FOLDER/bin/map-file-o-table.sh $FILE_NAME $SOURCE_FILE > $O_TABLE_SQL

echo "        MAP-FILE ADAPTOR CREATING INSERT TABLE METADATA SCRIPT"
$PRECISION100_FOLDER/bin/map-file-tab-columns.sh $FILE_NAME $SOURCE_FILE > $O_TAB_COLUMN_SQL

echo "        MAP-FILE ADAPTOR CREATING TRANSFORM SCRIPT"
$PRECISION100_FOLDER/bin/map-file-transform.sh $FILE_NAME $SOURCE_FILE > $TRANSFORM_SQL
